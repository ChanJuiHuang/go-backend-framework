...
func (suite *RegisterExecutorTestSuite) TestRegisterExecutor() {
	...
	assert.NotEmpty(suite.T(), service.Registry.Get("consoleLogger"))
	assert.NotEmpty(suite.T(), service.Registry.Get("fileLogger"))
	assert.NotEmpty(suite.T(), service.Registry.Get("accessLogger"))
